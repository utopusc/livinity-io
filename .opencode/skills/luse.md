<!--
  source-sha: 9d8abc808288d399fd311cc010083eeaf243324e350b3a5cb33593c0976a09d3

  AUTO-GENERATED FROM docs/luse/ — DO NOT EDIT.
  Re-run scripts/sync-luse-skills.sh to refresh.

  Agent: OpenCode
  Format: PLACEHOLDER — OpenCode skill format is not yet pinned for
  Liv AI. This file ships the canonical Luse prose as plain markdown
  so OpenCode agents that scan their skills directory at least
