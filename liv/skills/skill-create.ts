...
4. **tools**: Comma-separated tool names the skill needs (choose from: shell, files, web_search, scrape, memory_search, memory_add, docker_list, docker_manage, docker_exec, pm2, sysinfo, logs, cron, whatsapp_send, task_state, progress_report, subagent_create, subagent_list, subagent_message)
