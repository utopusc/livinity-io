...
/**
 * Phase 201-04 — Ported from livos/packages/ui/src/components/assistant-ui/
 *   composer-trigger-popover.tsx (Plan 200-02 ship).
 *
 * Path remap during port:
 *   @/shadcn-lib/utils → @/lib/utils
 *
 * Renders the categorical popover used by `@` (mention) + `/` (slash) pickers.
 * Internally driven by `ComposerPrimitive.Unstable_TriggerPopover*` from
 * @assistant-ui/react — no shadcn Popover dependency.
 */
