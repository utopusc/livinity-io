...
const DOCK_LABELS: Record<string, string> = {
	...
	// Phase 231 retirement — legacy Liv/Chat dock-tile label entries removed
	// (were Phase 203 Hot-fix F). Liv Assistant (Phase 227) is the v42 chat
	// surface and has its own DockItem in dock.tsx with a hard-coded label.
}
...
const DOCK_ICONS: Record<string, DockGlyph> = {
	...
	// Phase 231 retirement — legacy Liv/Chat dock-tile icon entries removed.
}
