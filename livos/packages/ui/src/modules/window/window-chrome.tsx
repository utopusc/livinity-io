	...
	return (
		<div className='relative flex items-center'>
			...
			<button
				...
				className='absolute right-full mr-3 group flex items-center justify-center w-9 h-9 rounded-full bg-white/90 backdrop-blur-lg border border-border-default shadow-elevation-md hover:bg-destructive hover:border-destructive/80 transition-all duration-200'
