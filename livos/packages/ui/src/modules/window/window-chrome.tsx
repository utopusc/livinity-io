...
export function WindowChrome({title, windowWidth, onClose, onFullscreen, onMinimize}: WindowChromeProps) {
	return (
		<div className='relative flex items-center gap-2' style={{width: windowWidth}}>
			...
			<div className='flex h-9 min-w-0 flex-1 items-center justify-start rounded-full border border-dash-line bg-white/95 px-4 shadow-[0_2px_8px_rgba(0,0,0,0.08)] dark:border-white/10 dark:bg-zinc-800/95 dark:shadow-[0_2px_8px_rgba(0,0,0,0.4)] cursor-grab active:cursor-grabbing'>
