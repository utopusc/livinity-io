...
>(({className, style, ...props}, ref) => (
	<DialogPrimitive.Overlay ref={ref} className={cn(dialogOverlayClass, className)} {...props} style={{...style, zIndex: 99999}} />
))
...
>(({className, ...props}, ref) => (
	<DialogPrimitive.Title
		ref={ref}
		className={cn('text-left text-heading -tracking-2', className)}
		{...props}
	/>
))
...
>(({className, ...props}, ref) => (
	<DialogPrimitive.Description
		ref={ref}
		className={cn('text-left text-body -tracking-2 text-text-secondary', className)}
		{...props}
	/>
))
