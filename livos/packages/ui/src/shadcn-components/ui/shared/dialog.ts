...
export const dialogContentClass = tw`fixed left-[50%] top-[50%] z-50 flex flex-col translate-x-[-50%] translate-y-[-50%] gap-6 rounded-24 bg-dialog-content/75 contrast-more:bg-dialog-content p-8 shadow-dialog backdrop-blur-2xl contrast-more:backdrop-blur-none duration-200 outline-none max-h-[calc(100%-16px)] border border-border-subtle`
