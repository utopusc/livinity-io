...
>(({className, dialogInset, scrollbarClass, orientation = 'vertical', ...props}, ref) => (
	<ScrollAreaPrimitive.ScrollAreaScrollbar
		...
		className={cn(
			'group flex touch-none select-none rounded-l transition-colors hover:bg-black/3',
		...
		{...props}
	>
		<ScrollAreaPrimitive.ScrollAreaThumb className='relative flex-1 rounded-full bg-black/12 group-hover:bg-black/25' />
	</ScrollAreaPrimitive.ScrollAreaScrollbar>
))
