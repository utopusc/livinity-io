	...
	return (
		<MarkdownPrimitive
			...
			components={{
				...
				a: (props) => (
					<a
						className='decoration-border-default underline-offset-2 outline-none transition-opacity hover:opacity-80 focus:opacity-80'
						target='_blank'
						{...props}
					/>
				),
...
const textClass = tw`prose prose-sm prose-neutral overflow-x-hidden`
