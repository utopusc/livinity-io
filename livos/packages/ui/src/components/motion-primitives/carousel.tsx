  ...
  return (
    ...
    >
      <button
        ...
        className={cn(
          'pointer-events-auto h-fit w-fit rounded-full bg-card-bg p-2 transition-opacity duration-300 dark:bg-card-bg-2',
          alwaysShow
            ? 'opacity-100'
      ...
      >
        <ChevronLeft
          className='stroke-text-secondary dark:stroke-text-primary'
          size={16}
        />
      </button>
      <button
        ...
        {Array.from({ length: itemsCount }, (_, i) => (
          <button
            ...
            className={cn(
              ...
              index === i
                ? 'bg-text-primary dark:bg-card-bg'
                : 'bg-text-primary/50 dark:bg-card-bg/50',
              classNameButton
            )}
          />
        ))}
