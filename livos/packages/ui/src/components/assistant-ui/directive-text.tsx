      ...
      <>
        {segments.map((seg, i) => {
          ...
          return (
            <Badge
              key={i}
              // Phase 200-02 Rule 1 fix: local Badge has no `info` variant —
              // closest semantic match is `primary` (brand-tinted highlight).
              // `size` prop dropped — local Badge does not accept it.
              variant="primary"
