...
// Phase 200-02 (D-200-16): single intentional delta from upstream registry.
// `composerSlot` lets callers (assistant.tsx) inject a custom Composer
// (e.g. <LivAiComposer /> from Plan 200-05) without forking the canonical
// Thread wholesale. When omitted, the verbatim default Composer is used.
