...
export function LivOSInstructions({username, password, sharename}: Props) {
	...
	return (
		<div className='space-y-4'>
			<InstructionContainer>
				...
				<InstructionItem>
					<Trans
						i18nKey='files-share.instructions.livos.enter-username'
						components={{field: <InlineCopyableField value={username} />}}
					/>
				</InstructionItem>
				<InstructionItem>
					<Trans
						i18nKey='files-share.instructions.livos.enter-password'
						components={{field: <InlineCopyableField value={password} />}}
					/>
				</InstructionItem>
				{sharename ? (
					<InstructionItem>
						<Trans i18nKey='files-share.instructions.livos.select-sharename' values={{sharename}} />
					</InstructionItem>
				) : null}
			</InstructionContainer>
			...
			>
				<Trans i18nKey='files-share.instructions.livos.backup.title' />
				...
				{showBackup && (
					...
					>
						<InstructionContainer>
							<InstructionItem>
								<Trans
									i18nKey='files-share.instructions.livos.backup.follow-then-go-to'
									values={{settings: t('settings'), backups: t('backups')}}
								/>
							</InstructionItem>
							<InstructionItem>
								<Trans
									i18nKey='files-share.instructions.livos.backup.select-add'
									values={{addLivinityOrNas: t('backups-add-livinity-or-nas', {defaultValue: 'Add Livinity or NAS'})}}
								/>
							</InstructionItem>
							<InstructionItem>
								<Trans i18nKey='files-share.instructions.livos.backup.select-connected' />
							</InstructionItem>
							<InstructionItem>
								<Trans i18nKey='files-share.instructions.livos.backup.follow-onscreen' />
							</InstructionItem>
						</InstructionContainer>
					</motion.div>
				)}
