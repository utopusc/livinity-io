...
// livinityd still returns true if EEXIST, but doesn't create the folder.
// So even if we don't throw an error here, livinityd will still handle the duplicate name.
