// Modal presented when the chosen backup folder already contains an Livinity backup
// that is currently in use on this Livinity. Provides a quick action to manage it.
