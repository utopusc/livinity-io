...
import {Category, LIVINITY_APP_STORE_ID} from '@/modules/app-store/constants'
...
export function useAvailableApps(registryId: string = LIVINITY_APP_STORE_ID) {
...
export function useAvailableApp(id?: string | null, registryId: string = LIVINITY_APP_STORE_ID) {
