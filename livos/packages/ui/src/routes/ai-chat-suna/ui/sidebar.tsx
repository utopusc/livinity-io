// Ported verbatim from Suna: components/ui/sidebar.tsx
// Substitutions: 'use client' removed; @/lib/utils -> shadcn-lib/utils;
// @/components/ui/* -> local shadcn-components; @/hooks/use-mobile -> local impl
...
// Local mobile detection — replaces @/hooks/use-mobile
