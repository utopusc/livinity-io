...
function StorageSection() {
	...
	return (
		<>
			...
			{isLoading && <AppListSkeleton systemApps={[systemAppsKeyed.LIVINITY_system, systemAppsKeyed.LIVINITY_files]} />}
...
function MemorySection() {
	...
	return (
		<>
			...
			{isLoading && <AppListSkeleton systemApps={[systemAppsKeyed.LIVINITY_system]} />}
			<AppList apps={apps} formatValue={(v) => maybePrettyBytes(v)} />
		</>
	)
}
	...
	return (
		<div className={appListClass}>
			{apps?.map(({id, used}) => {
				...
				if (id === 'livinityd-system') {
					icon = systemAppsKeyed.LIVINITY_system.icon
					title = systemAppsKeyed.LIVINITY_system.name
				}
				if (id === 'livinityd-files') {
					icon = systemAppsKeyed.LIVINITY_files.icon
					title = systemAppsKeyed.LIVINITY_files.name
				}
