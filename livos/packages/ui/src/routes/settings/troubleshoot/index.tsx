...
import TroubleshootLivinityOs from '@/routes/settings/troubleshoot/livos'
			...
			<DialogPortal>
				...
				<Suspense>
					<Routes>
						...
						<Route path='/livos/:systemTab?' Component={TroubleshootLivinityOs} />
...
function PickerDialogContent() {
	...
	return (
		<ImmersivePickerDialogContentInit title={t('troubleshoot-pick-title')}>
			<ImmersivePickerItem
				title={t('livos')}
				description={t('troubleshoot.livos-description')}
				to='/settings/troubleshoot/livos/livos'
			/>
			<ImmersivePickerItem
