...
const AnimatedLivinityHomeIcon = memo(
							...
							{isFlipped ? (
								<>
									<div
										...
										style={{
											backgroundImage: isFlipped ? 'url(/figma-exports/livinity-home-device-info-grain.png)' : 'none',
									...
									<div className='pointer-events-none relative h-full w-full select-none'>
										<div className='absolute left-1/2 top-1/2 w-full -translate-x-1/2 -translate-y-1/2 text-center text-[11px] text-white/60'>
											...
											>
												<span className='inline whitespace-pre'>Designed by Livinity. Assembled in China.</span>
											</motion.div>
										</div>
										<div className='absolute bottom-[20%] left-1/2 flex -translate-x-1/2 flex-col items-center gap-2'>
											...
											<motion.img
												...
												transition={{delay: 0.2, duration: 0.5, ease: [0.22, 1, 0.36, 1]}}
												src='/figma-exports/livinity-home-certifications.svg'
												className='w-[80px]'
												draggable='false'
											/>
											<LaserEngraving
...
export default AnimatedLivinityHomeIcon
