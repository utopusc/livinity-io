export function NoForgotPasswordMessage() {
	return (
		<p className='text-12 font-normal leading-tight -tracking-2 text-text-tertiary'>
			...
			{/* https://surajmahraj.notion.site/LivOS-1-0-UI-Polish-a75c2f43893d49f4ae1e572e1455c33e#:~:text=My%20idea%20for%20%E2%80%98-,super%20strong,-%E2%80%99%20is%20that%20this */}
