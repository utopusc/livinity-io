	...
	theme: {
		...
		extend: {
			...
			colors: {
				...
				// Semantic surface / border / text colors — wired to CSS vars so the
				// whole window family swaps in dark mode (2026-05-15). The original
				// static rgba values (rgba(0,0,0,...)) shipped a permanent light-theme
				// look; the new tokens come from tokens.css :root + body.dark.
