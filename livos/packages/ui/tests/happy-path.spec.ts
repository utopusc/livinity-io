...
import {resetLivinitydAndStart} from './misc'

const TEST_USER = faker.person.firstName()
const TEST_PASSWORD = 'sdfsdf'

let stopLivinityd: (() => void) | null = null

test.beforeAll(async () => {
	// TODO: first check if we can reach livinityd. If so, we wanna reset it and restart it.
