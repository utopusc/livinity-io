	...
	return (
		<div className='flex flex-col flex-wrap items-start gap-8 bg-white/10 p-8'>
			...
			<div className='flex gap-4'>
				<HostEnvironmentIcon />
				<HostEnvironmentIcon environment='livinity-home' />
			...
			<div className='flex flex-wrap gap-2 bg-red-500/10'>
				<DeviceInfoContent />
				<DeviceInfoContent livinityHostEnvironment='livinity-home' modelNumber='U130121' serialNumber='U230300078' />
				<DeviceInfoContent livinityHostEnvironment='raspberry-pi' />
				<DeviceInfoContent livinityHostEnvironment='unknown' />
				<DeviceInfoContent livinityHostEnvironment='docker-container' />
			</div>
			<H2>Progress Card</H2>
			<Card>
			...
			<Button
				onClick={() => {
					localStorage.removeItem('LIVINITY_temp-unit')
