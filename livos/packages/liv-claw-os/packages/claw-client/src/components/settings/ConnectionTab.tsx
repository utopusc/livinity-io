...
/**
 * Phase 205-02 — Connection tab body.
 *
 * Verbatim extraction of the pre-Phase-205 SettingsDialog body (status
 * banner + gateway URL/token form + Save&Connect snapshot/race logic).
 * SettingsDialog now wraps this component in a SegmentedTabs strip with
 * 3 tabs (Connection → MCP Servers → Gateway). The Connection tab
 * preserves the existing form 1:1; the other tabs are placeholder
 * shells filled in by Waves 2 + 3.
 */
