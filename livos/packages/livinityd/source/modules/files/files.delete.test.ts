...
test('delete() throws invalid error without auth token', async () => {
	await expect(livinityd.unauthenticatedClient.files.delete.mutate({path: '/Trash/test-file.txt'})).rejects.toThrow(
		'Invalid token',
	)
})
...
test('delete() successfully deletes a file in trash', async () => {
	...
	const trashDir = `${livinityd.instance.dataDirectory}/trash`
	const metaDir = `${livinityd.instance.dataDirectory}/trash-meta`
	...
	// Delete the file
	await livinityd.client.files.delete.mutate({path: '/Trash/test-file.txt'})
...
test('delete() successfully deletes a directory in trash', async () => {
	...
	await livinityd.client.files.delete.mutate({path: '/Trash/test-dir'})
...
test('delete() silently succeeds when trying to delete a non-existent file', async () => {
	...
	await expect(livinityd.client.files.delete.mutate({path: '/Trash/non-existent-file.txt'})).resolves.toBe(true)
})

test('delete() throws error when trying to delete a file outside of trash', async () => {
	// Create a test file outside of trash
	const homeDir = `${livinityd.instance.dataDirectory}/home`
	...
	await expect(livinityd.client.files.delete.mutate({path: '/Home/protected-file.txt'})).rejects.toThrow()
...
test('delete() can delete a nested file in trash', async () => {
	...
	await livinityd.client.files.delete.mutate({path: '/Trash/test-dir/nested/file2.txt'})
...
test('delete() handles errors gracefully', async () => {
	...
	await expect(livinityd.client.files.delete.mutate({path: '/Trash/test-file.txt'})).resolves.toBe(false)
...
test('delete() can handle files with special characters in the name', async () => {
	...
	// Delete the file
	await livinityd.client.files.delete.mutate({path: `/Trash/${specialFileName}`})
...
test('delete() throws on directory traversal attempt', async () => {
	await expect(
		livinityd.client.files.delete.mutate({
...
test('delete() throws on symlink traversal attempt', async () => {
	...
	const targetDir = `${livinityd.instance.dataDirectory}/symlink-target`
