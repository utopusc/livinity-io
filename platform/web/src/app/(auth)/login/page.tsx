  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      <div className="rounded-xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
        <h2 className="mb-4 text-lg font-semibold text-zinc-900 dark:text-zinc-50">Sign in</h2>
        ...
        <div className="mt-3 text-center text-sm text-zinc-500">
          <Link href="/forgot-password" className="hover:text-zinc-700 dark:hover:text-zinc-300">
            Forgot password?
          </Link>
        </div>
      </div>
