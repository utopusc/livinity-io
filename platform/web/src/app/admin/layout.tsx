...
export const metadata: Metadata = {
  title: 'Admin · Livinity',
  description: 'Manage apps catalog for the LivOS store.',
};

export default function AdminLayout({ children }: { children: React.ReactNode }) {
  return (
    <div
      className={`${geist.variable} ${geistMono.variable} ${instrumentSerif.variable} admin-root`}
      style={{
