...
Subject to applicable law, you may: **access** your data; request **rectification** of inaccurate data; request **erasure** ("right to be forgotten"); **restrict** or **object** to processing; obtain **portability** of data you provided; and **withdraw consent** at any time. You also have the right to **lodge a complaint** with your supervisory authority. To exercise these rights, contact [CONTACT EMAIL]; we respond within the timeframes the law requires.

## 9. Your Rights — KVKK (Türkiye)

If you are in Türkiye, under Article 11 of the KVKK you have the right to: learn whether your data is processed and request information about it; learn the purpose of processing and whether it is used accordingly; know the third parties to whom data is transferred domestically or abroad; request correction of incomplete or inaccurate data; request erasure or destruction; request that corrections/erasures be notified to third parties; object to results produced solely by automated analysis; and claim compensation for damage caused by unlawful processing. Submit requests to [CONTACT EMAIL] (or to the registered data-controller address [COMPANY ADDRESS]); we respond within the periods set by the KVKK.
...
The Service is not directed to children under 16 (or the minimum age in your jurisdiction), and we do not knowingly collect their data. If you believe a child has provided us data, contact [CONTACT EMAIL] and we will delete it.
...
Privacy questions or rights requests: [CONTACT EMAIL] · [COMPANY LEGAL NAME], [COMPANY ADDRESS].`,
};
