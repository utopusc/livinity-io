        ...
        <div className="max-w-5xl mx-auto relative">
          <div className="p-3 flex items-center justify-between">
            <div className="flex items-center gap-4">
              <a href="https://livinity.io" className="text-lg font-bold tracking-tight text-foreground hover:opacity-80 transition-opacity">livinity.io</a>
              <span className="text-border">/</span>
              <h1 className="text-lg font-semibold tracking-tight text-muted-foreground">Changelog</h1>
            </div>
            <ThemeToggle />
          </div>
        </div>
      ...
      <div className="max-w-5xl mx-auto px-6 lg:px-10 pt-10">
        <div className="relative">
          {sortedChangelogs.map((changelog) => {
            ...
            const tags = Array.isArray(changelog.data.tags) ? changelog.data.tags : []
