...
|---|------|-----|-------|------------|
| 1 | 133-01 | A (wizard) | Server5 `/opt/platform/web/src/app/api/account/api-keys/route.ts` + pm2 restart web | true |
...
| 3 | 133-03 | UAT | Operator-walked fresh-user verify | false |
