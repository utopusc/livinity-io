   ...
   async executeSubAgent(sessionId: string): Promise<void> {
     ...
     try {
       ...
       const runner = new SdkAgentRunner({
         ...
         maxTokens: session.maxTokens, // MULTI-05: 50k token budget enforced
         tier: 'sonnet',
...
8. Turn limit enforced at 8 (maxTurns), token budget at 50k (maxTokens passed to SdkAgentRunner)
</verification>
