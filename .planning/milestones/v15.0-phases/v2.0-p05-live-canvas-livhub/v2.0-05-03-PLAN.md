...
type: execute
wave: 3
depends_on: ["v2.0-05-01", "v2.0-05-02"]
files_modified:
...
Use `useMemo` to avoid regenerating srcdoc on every render.
  ...
  <verify>
1. Read canvas-iframe.tsx — confirm buildSrcdoc has 5 separate template functions (buildReactSrcdoc, buildHtmlSrcdoc, buildSvgSrcdoc, buildMermaidSrcdoc, buildRechartsSrcdoc)
