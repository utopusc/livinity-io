...
**Plans:** 1/1 plans complete
Plans:
- [x] 12-01-PLAN.md — Harden buildSdkTools() with image support, truncation, logging + verification script
...
Plans:
- [x] 15-01-PLAN.md — Fix tool lifecycle in reducer + animated tool-specific card components
...
**Plans:** 2 plans
Plans:
- [ ] 17-01-PLAN.md — Backend persistence: wire SDK sessions to Redis conversation storage + tRPC routes
...
| 17. Session Management + History | v20.0 | 0/2 | In progress | - |
