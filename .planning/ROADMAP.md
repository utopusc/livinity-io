...
### Phase 203: Liv AI on openclaw-os + Desktop App Integration — 🟡 EXECUTING (Wave 2 in progress 2026-05-23 — 4 of 13 plans complete)
...
- [ ] 203-05-PLAN.md — /openclawos/handshake JWT→Ed25519 bridge + Caddy /liv-ai-app/* → :18789
- [ ] 203-06-PLAN.md — Luse + 11 built-in tools as openclaw gateway tools via liv-claw-plugin (ApprovalManager RPC preserved)
- [ ] 203-07-PLAN.md — LivOSAgent + agent-runtime factory + memory + boot toggle (Branch A or B per 203-01 spike)
- [ ] 203-08-PLAN.md — Purge @mastra/* + LivOSMastra; move runtime files to agent-runtime/ (Phase 202 contracts preserved)
- [ ] 203-09-PLAN.md — Purge @assistant-ui/* + chat surface from liv-ai-app; keep Phase 202 /agents + /settings
- [ ] 203-10-PLAN.md — Desktop integration: OpenUI apps register as dock icons + OpenUiAppContent window
- [ ] 203-11-PLAN.md — /liv-ai-app/apps/[slug] standalone OpenUI app renderer
- [ ] 203-12-PLAN.md — Mini PC deploy + smoke log + update.sh Phase 203 patches
- [ ] 203-13-PLAN.md — 203-VERIFICATION.md + STATE/ROADMAP flip + final commit
...
**Resume command:** `/gsd-execute-phase 203` (CONTEXT + 13 PLANs on disk).
---
