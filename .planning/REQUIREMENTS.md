...
- [x] **BUILD-04**: GitHub Actions workflow her PR'da Docker container içinde tam `update.sh` koşar ve livinityd boot health check (`curl -fsS http://localhost:8080/health` + livinityd PID alive 30s) yapar; başarısız PR mergelenemez.
