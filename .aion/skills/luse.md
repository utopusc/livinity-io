<!--
  source-sha: cb336939292bf69bcd4f735e01c644fdd6bbf070be59f84f7fc0b2d3e85fce58

  AUTO-GENERATED FROM docs/luse/ — DO NOT EDIT.
  Re-run scripts/sync-luse-skills.sh to refresh.

  Agent: Aion CLI
  Format: PLACEHOLDER — Aion CLI skill format is not yet pinned for
  Liv AI. This file ships the canonical Luse prose as plain markdown
  so Aion CLI agents that scan their skills directory at least
