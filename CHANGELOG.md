...
### Added (shipping next, in the `v1.2.0-beta.1` prerelease)
- **Safety Snapshots (on by default)** — the box backs itself up to its own
  internal disk every hour with zero setup.
